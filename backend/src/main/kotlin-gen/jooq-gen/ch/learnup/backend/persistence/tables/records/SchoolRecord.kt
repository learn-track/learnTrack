...
public open class SchoolRecord private constructor() : UpdatableRecordImpl<SchoolRecord>(SchoolTable.SCHOOL) {
    ...
    public open var address: String
        set(value): Unit = set(2, value)
    @NotNull
        get(): String = get(2) as String

    public open var city: String
        set(value): Unit = set(3, value)
    @NotNull
        get(): String = get(3) as String

    public open var postcode: Int
     ...
     */
    public constructor(id: UUID, name: String, address: String, city: String, postcode: Int, created: LocalDateTime? = null, updated: LocalDateTime? = null): this() {
        this.id = id
        this.name = name
     ...
     * Create a detached, initialised SchoolRecord
     */
    public constructor(value: School?): this() {
        if (value != null) {
            this.id = value.id
