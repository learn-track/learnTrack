...
public val T_USER__FK_USER_SUBJECT: ForeignKey<UserRecord, SubjectRecord> = Internal.createForeignKey(UserTable.USER, DSL.name("fk_user_subject"), arrayOf(UserTable.USER.SUBJECT_ID), ch.learntrack.backend.persistence.keys.PK_SUBJECT, arrayOf(SubjectTable.SUBJECT.ID), true)
